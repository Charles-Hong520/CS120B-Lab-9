 ...
 *
 * Demo Link: https://drive.google.com/file/d/1LEi1tdM5AVmvFrqs7zYEjmL9mQvFfFYN/view?usp=sharing
 */
#include <avr/io.h>
...
#define A0 (PINA&0x01)
enum State {start, release, up, down, fail} state;
double notes[] = {0,E,0,B,0, B,0, A,0, B,0, A,0, G,0, A,0, A,0, G,0, E,0, G,0,E};
unsigned char note_period[] = {1,9,1,9,1,4,1,4,1,9,1,4,1,4,1,9,1,4,1,4,1,4,1,4,1,9}; //26
const unsigned long periodGCD = 60;
const unsigned char size = 26;
